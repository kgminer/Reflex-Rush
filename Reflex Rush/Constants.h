...
static double SPAWN_TIMER = 1.7;
static double CONVERT_MS_TO_SEC = 1000.0;
static int CHANCE_TO_SPAWN_ASTEROID = 30, ASTEROID_ARRAY_ROWS = 5, ASTEROID_ARRAY_COLS = 8;
static int AUDIO_FREQUENCY = 44100, AUDIO_CHANNELS = 2, AUDIO_CHUNKSIZE = 2048;
static int STARTING_LEVEL_THRESHOLD = 6000;
...
static int SCORE_LABEL_SIZE = 25, SCORE_LABEL_X = 0, SCORE_LABEL_Y = 0;
...
//Player Constants
static int PLAYER_SCREEN_SIZE_X, PLAYER_SCREEN_SIZE_Y, PLAYER_SCREEN_SIZE_W, PLAYER_SCREEN_SIZE_H;
//UIManager Constants